...
const flameRoutes = require("./flame.routes");
const adminFlameRoutes = require("./adminFlame.routes");
...
const flameProductsRoutes = require("./flameProducts.routes");
const flameProductsAdminRoutes = require("./flameProductsAdmin.routes");
...
module.exports = (app) => {
  ...
  app.use("/flames", flameRoutes);
  app.use("/admin/flames", adminFlameRoutes);
  ...
  app.use("/flames", flameProductsRoutes);
  app.use("/admin/flames", flameProductsAdminRoutes);
