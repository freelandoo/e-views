    ...
    <PageShell className="tabloid-account-page">
      <main className="relative z-10 mx-auto max-w-lg px-4 py-8 md:py-10">
        ...
        <div className="space-y-4">
          ...
          <button
            type="button"
            className="inline-flex w-full items-center justify-center border-2 border-[#0B0B0D] bg-[#C8102E] px-5 py-4 text-sm font-black uppercase tracking-[0.12em] text-white shadow-[5px_5px_0_0_#0B0B0D] transition hover:-translate-y-0.5 hover:shadow-[7px_7px_0_0_#0B0B0D] disabled:cursor-not-allowed disabled:opacity-55"
            onClick={handlePagar}
