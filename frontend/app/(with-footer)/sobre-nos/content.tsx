      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" data-stagger>
            {values.map((v, i) => (
              <div key={v.title} className="bg-[#1D1810] border border-[#2A2218] rounded-xl p-6 hover:border-[#C8102E]/30 hover:shadow-[0_0_30px_rgba(242,196,9,0.06)] transition-all" data-card>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <div className="flex flex-wrap gap-4 justify-center" data-reveal>
            ...
            <Link href="/anunciar-servicos" className="inline-flex items-center border border-[#2A2218] text-[#F5F1E8] font-medium px-8 py-4 rounded-lg hover:border-[#C8102E]/40 transition-all text-lg">
