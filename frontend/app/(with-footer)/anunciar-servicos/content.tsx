  ...
  return (
    <main className="flex-1 bg-[#0b0804]">
      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="flex flex-wrap gap-4" data-reveal>
            ...
            <Link href="/comofunciona" className="inline-flex items-center border border-[#2A2218] text-[#F5F1E8] font-medium px-6 py-3 rounded-lg hover:border-[#C8102E]/40 transition-all">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl" data-stagger>
            {steps.map((step, i) => (
              <div key={step.n} className="flex gap-4" data-card>
                <div className="flex-shrink-0 w-10 h-10 bg-[#C8102E]/10 rounded-full flex items-center justify-center text-[#C8102E] font-bold text-sm border border-[#C8102E]/20">
                  {step.n}
                </div>
                <div>
      ...
      <section className="py-16 md:py-24 bg-[#1D1810]/20">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-3" data-stagger>
            {included.map((item, i) => (
              <div key={item} className="flex items-start gap-3 bg-[#1D1810] border border-[#2A2218] rounded-lg px-4 py-3 hover:border-[#C8102E]/20 transition-colors" data-card>
                <span className="text-[#C8102E] mt-0.5 font-bold">✓</span>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-xl text-center">
          ...
          <div className="bg-[#1D1810] border border-[#C8102E]/20 rounded-2xl p-8 shadow-[0_0_50px_rgba(242,196,9,0.06)] mb-6" data-reveal>
            ...
            <Link href="/cadastro" className="inline-flex items-center justify-center w-full bg-[#C8102E] text-white font-semibold px-8 py-3.5 rounded-lg hover:bg-[#C8102E]/90 hover:shadow-[0_0_20px_rgba(242,196,9,0.35)] transition-all">
      ...
      <section className="py-16 md:py-24 bg-[#1D1810]/20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3" data-stagger>
            {tags.map((tag, i) => (
              <span key={tag} className="bg-[#1D1810] border border-[#2A2218] rounded-full px-4 py-2 text-sm text-[#F5F1E8] hover:border-[#C8102E]/40 hover:text-[#C8102E] transition-all cursor-default" data-card>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[350px] w-[700px] rounded-full bg-[#C8102E]/5 blur-[100px]" />
        <div className="container mx-auto px-4 text-center relative">
          ...
          <div className="flex flex-wrap gap-4 justify-center" data-reveal>
            ...
            <Link href="/precos" className="inline-flex items-center border border-[#2A2218] text-[#F5F1E8] font-medium px-8 py-4 rounded-lg hover:border-[#C8102E]/40 transition-all text-lg">
