...
export const metadata: Metadata = {
  title: "Regulamento da Casa Views — E-Views",
  description:
...
const sections = [
  {
    ...
    paragraphs: [
      "A Casa Views é um programa de conteúdo (reality show) promovido pela E-Views, organizado em temporadas, no qual participantes convidados produzem conteúdo e competem em um ranking de engajamento. A audiência acompanha, interage e pode acumular pontos conforme as regras deste Regulamento.",
      "Este Regulamento integra os Termos de Uso da E-Views. Em caso de divergência sobre a mecânica da Casa Views, prevalece este documento.",
    ],
  },
  {
    ...
    items: [
      ...
      "A E-Views pode, a seu critério, oferecer prêmios em dinheiro, créditos, produtos ou benefícios, descritos nas comunicações de cada temporada.",
    ],
  },
  {
    title: "3. Participantes",
    items: [
      "Os participantes são convidados pela E-Views e devem ser maiores de 18 anos e plenamente capazes.",
      "Ao aceitar participar, o participante autoriza o uso de sua imagem, voz, nome e conteúdo produzido durante a temporada para fins de divulgação da Casa Views e da E-Views, nos canais da plataforma e em redes sociais.",
  ...
  },
  {
    ...
    items: [
      ...
      "Os critérios de pontuação são informados nas comunicações da temporada e podem ser ajustados pela E-Views para preservar a integridade da competição.",
  ...
  },
  {
    ...
    items: [
      ...
      "A E-Views pode definir limites, validade, regras antifraude e condições de resgate, e pode encerrar ou alterar a mecânica de pontos da audiência a qualquer tempo, mediante aviso na plataforma.",
  ...
  },
  {
    ...
    items: [
      "Durante a Casa Views, a E-Views pode disponibilizar uma loja de produtos e itens (Conveniência Views), eventualmente associada aos participantes.",
  ...
  },
  {
    ...
    items: [
      "Para acumular ou resgatar pontos, o usuário deve possuir conta ativa e regular na E-Views.",
  ...
  },
  {
    ...
    items: [
      "A E-Views pode alterar datas, regras, critérios, prêmios ou suspender e encerrar uma temporada da Casa Views por motivos operacionais, técnicos, legais ou de força maior.",
      "A E-Views não garante disponibilidade ininterrupta da transmissão, das interações ou do acúmulo de pontos.",
...
export default function CasaViewsRegulamentoPage() {
  return (
    <LegalDocument
      ...
      intro="Este Regulamento descreve as regras do reality show Casa Views da E-Views: participantes, ranking, premiação por mérito e a participação da audiência. A participação é gratuita e os prêmios são atribuídos por desempenho e engajamento, sem sorteio."
      sections={sections}
