...
export const metadata: Metadata = {
  title: "Política de Moderação e Denúncias — E-Views",
  description: "Como a E-Views modera conteúdo, processa denúncias, em que prazos e quais sanções aplica.",
}
...
const sections = [
  {
    title: "1. Objetivo",
    items: [
      "Esta política descreve como a E-Views modera conteúdo e contas, como os usuários podem denunciar violações e em que prazos as denúncias são analisadas.",
  ...
  },
  {
    ...
    paragraphs: [
      "A E-Views trata as denúncias de acordo com a gravidade do caso, observando, como metas operacionais de diligência, os seguintes critérios:",
    ],
    items: [
  ...
  },
  {
    ...
    paragraphs: ["Conforme o resultado da análise, a E-Views pode adotar, entre outras medidas:"],
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      "Nos demais casos, a responsabilização da E-Views por conteúdo de terceiros, em regra, depende do descumprimento de ordem judicial específica de remoção (art. 19 do Marco Civil da Internet).",
      "Conteúdo que envolva crimes, especialmente contra crianças e adolescentes, pode ser comunicado às autoridades competentes.",
      "A E-Views atende a ordens judiciais e a requisições legais válidas.",
    ],
  },
  {
    title: "10. Isenção de responsabilidade",
    paragraphs: [
      "A moderação é feita com diligência, mas não garante a identificação prévia de todo conteúdo impróprio. Nos termos do Marco Civil da Internet, a responsabilidade da E-Views por conteúdo de terceiros observa a legislação aplicável.",
    ],
  },
  {
    title: "11. Contato",
...
export default function ModerationPolicyPage() {
  return (
    <LegalDocument
      ...
      intro="Esta política explica como a E-Views modera o conteúdo publicado na plataforma, como qualquer usuário pode denunciar violações, em que prazos as denúncias são analisadas e quais medidas podem ser aplicadas."
      sections={sections}
      footerPrefix="Esta política complementa as Diretrizes da Comunidade da E-Views. Veja também nossos"
      links={[
