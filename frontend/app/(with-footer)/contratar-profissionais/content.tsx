      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="flex flex-wrap gap-4" data-reveal>
            ...
            <Link href="/search" className="inline-flex items-center border border-[#2A2218] text-[#F5F1E8] font-medium px-6 py-3 rounded-lg hover:border-[#C8102E]/40 transition-all">
      ...
      <section className="py-16 md:py-24 bg-[#1D1810]/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl" data-stagger>
            {steps.map((step, i) => (
              <div key={step.n} className="flex gap-4 bg-[#1D1810] border border-[#2A2218] rounded-xl p-6 hover:border-[#C8102E]/20 transition-all" data-card>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" data-stagger>
            {categories.map((cat, i) => (
              <div key={cat.title} className="bg-[#1D1810] border border-[#2A2218] rounded-xl p-6 hover:border-[#C8102E]/30 hover:shadow-[0_0_30px_rgba(242,196,9,0.06)] transition-all" data-card>
              ...
              <ul className="space-y-2">
                {doesDo.map((item, i) => (
                  <li key={item} className="flex items-center gap-2 text-sm text-[#9A938A]">
                    <span className="text-[#C8102E] text-xs">●</span>{t(`doesDo.${i}`, item)}
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="mt-8 space-y-3" data-stagger>
            {tips.map((tip, i) => (
              <div key={tip} className="flex items-start gap-4 bg-[#1D1810] border border-[#2A2218] rounded-lg px-5 py-3.5 hover:border-[#C8102E]/20 transition-colors" data-card>
                <span className="text-[#C8102E]/50 text-xs mt-0.5 font-mono">{String(i + 1).padStart(2, "0")}</span>
