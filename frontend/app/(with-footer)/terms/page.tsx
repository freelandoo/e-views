...
const sections = [
  {
    ...
    items: [
      ...
      "Flames: créditos virtuais utilizados na plataforma, sem valor monetário e não sacáveis.",
      "Presentes: itens virtuais adquiridos com Flames e enviados durante transmissões ao vivo, regidos pelos Termos de Flames e Itens Digitais.",
  ...
  },
  {
    ...
    items: [
      ...
      "A plataforma oferece Flames, créditos virtuais sem valor monetário, não reembolsáveis e não sacáveis, conforme os Termos de Flames e Itens Digitais.",
  ...
  },
  {
    ...
    items: [
      ...
      "Carteira: acompanhamento de saldo, ganhos e repasses, e moeda virtual (Flames).",
