  ...
  return (
    <main className="fl-root relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#0b0804] px-4 py-12">
      <div
        ...
        style={{ background: "radial-gradient(120% 90% at 50% 0%, rgba(200, 16, 46,0.22), transparent 60%)" }}
      />
      <div className="relative w-full max-w-lg">
        <div className="fl-card fl-hard rounded-[6px] p-8 text-center sm:p-10">
          <span className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-[6px] border-2 border-[#0B0B0D] bg-[#C8102E] text-white">
