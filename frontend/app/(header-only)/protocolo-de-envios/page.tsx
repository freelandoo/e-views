...
export const metadata: Metadata = {
  title: "Protocolo de Envios | E-Views",
  description:
    "Como funciona a compra protegida da E-Views: O.S. de envio nas mensagens, provas em vídeo do vendedor, acompanhamento do rastreio e 7 dias para conferir. Seu dinheiro fica protegido até você receber.",
  openGraph: {
    title: "Protocolo de Envios E-Views",
    description:
