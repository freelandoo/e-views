        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: Sparkles, title: "Manifestação", text: "Banner e tag de identidade no headcard do perfil, com pagamento via Stripe ou Flames." },
              { icon: Crown, title: "Premium", text: "Destaque pago do perfil na vitrine, por período e cidade definidos." },
              { icon: Coins, title: "Flames", text: "Créditos virtuais para adquirir itens digitais dentro da plataforma." },
            ].map((card) => (
