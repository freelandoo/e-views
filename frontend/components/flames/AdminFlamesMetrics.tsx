export function AdminFlamesMetrics({ metrics }: { metrics: Record<string, number> | null }) {
  const items = [
    ["Flames emitidos hoje", metrics?.flames_issued_today || 0],
    ["Flames gastos hoje", metrics?.flames_spent_today || 0],
