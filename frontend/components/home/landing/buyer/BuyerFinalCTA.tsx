  ...
  return (
    <Section className="text-center">
      ...
      <div className="mt-7 flex flex-col items-center gap-3">
        <Link
          href="/search"
          className="inline-flex items-center justify-center gap-2 border-2 border-[#0B0B0D] bg-[#C8102E] px-7 py-3 text-sm font-bold text-[#1A1505] shadow-[5px_5px_0_0_#0B0B0D] transition-all hover:-translate-y-0.5 hover:shadow-[7px_7px_0_0_#C8102E] active:translate-y-0 active:shadow-[2px_2px_0_0_#0B0B0D]"
        >
          Encontrar agora
        </Link>
