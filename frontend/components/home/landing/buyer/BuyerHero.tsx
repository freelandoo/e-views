...
const CTA_CLASS =
  "inline-flex items-center justify-center gap-2 border-2 border-[#0B0B0D] bg-[#C8102E] px-6 py-3 text-sm font-bold text-[#1A1505] shadow-[4px_4px_0_0_#0B0B0D] transition-all hover:-translate-y-0.5 hover:shadow-[6px_6px_0_0_#C8102E] active:translate-y-0 active:shadow-[2px_2px_0_0_#0B0B0D]"
    ...
    <Section className="pt-10 sm:pt-14">
      ...
      <div className="mx-auto mt-10 max-w-[1100px]">
        <EditableImage
          ...
          className="aspect-[16/5] w-full border-2 border-[#0B0B0D] shadow-[6px_6px_0_0_#C8102E]"
