    ...
    <footer className="relative overflow-hidden border-t border-[#F5F1E8]/8 bg-[#100E0A] text-[#F5F1E8]">
      ...
      <div className="relative mx-auto w-full max-w-[1180px] px-5 py-14 sm:px-8">
        ...
        <div className="mb-12 border-b border-[#F5F1E8]/10 pb-12">
          <div className="mb-2 flex items-center gap-3 text-xs font-bold uppercase tracking-[0.3em] text-[#C8102E]">
        ...
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr_1.2fr]">
          ...
          {COLS.map((col) => (
            <div key={col.title}>
              <h3 className="text-xs font-bold uppercase tracking-[0.14em] text-[#C8102E]">{t(col.tk, col.title)}</h3>
          ...
          <div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center border border-[#F5F1E8]/15 text-[#C9C2B6] transition hover:border-[#C8102E] hover:text-[#C8102E]"
              >
            ...
            <h3 className="mt-6 text-xs font-bold uppercase tracking-[0.14em] text-[#C8102E]">{t("footerBaixeApp", "Baixe o app")}</h3>
            <div className="mt-3 inline-flex items-center gap-2 border border-[#F5F1E8]/15 px-3 py-2 text-sm text-[#C9C2B6]">
              <Smartphone className="h-4 w-4 text-[#C8102E]" /> {t("footerPwaNote", "Acesse pelo navegador ou instale como app (PWA)")}
            </div>
          </div>
        </div>
