...
const BACKEND_PUBLIC = "https://backend-production-1032.up.railway.app"
...
const securityHeaders = [
  ...
  // Ninguém embeda a E-Views em iframe (AdSense não exige o contrário).
...
const nextConfig = {
  ...
  async rewrites() {
    const backend =
      ...
      "https://backend-production-1032.up.railway.app"
    return {
      afterFiles: [
